...
const TrainingReportPDF = ({ data = [] }: { data: any }) => {
				...
				{data.map(({ name, data }: any, index: number) => (
					...
					>
						<View style={[styles.row, styles.bold, styles.header]}>
							<Text style={[styles.bg1, styles.colSmall]}>Weight</Text>
							<Text style={[styles.bg1, styles.colSmall]}>Set</Text>
							<Text style={[styles.bg1, styles.colSmall]}>Reps</Text>
							<Text style={[styles.bg1, styles.colLarge]}>Exercise</Text>
