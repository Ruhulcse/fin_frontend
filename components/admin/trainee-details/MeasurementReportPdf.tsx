      ...
      <Page style={styles.page}>
        <View style={styles.table}>
          {/* <View style={[styles.row, styles.bold, styles.header]}>
						<Text style={[styles.headCol1, styles.col]}>
							{measurement.armL}
						</Text>
						<Text style={[styles.headCol1, styles.col]}>
							{measurement.armR}
						...
						<Text style={[styles.headCol1, styles.colExtend]}>
							{measurement.date}
						</Text>
					</View> */}
          <View style={[styles.row, styles.bold, styles.header]}>
        ...
        <View style={styles.bottomTopArea}>
          ...
          <View style={styles.imageArea}>
            <Image style={styles.image} src={"/pictures/measurement/1.jpg"} />
            <Image style={styles.image} src={"/pictures/measurement/2.jpg"} />
            <Image style={styles.image} src={"/pictures/measurement/3.jpg"} />
            <Image style={styles.image} src={"/pictures/measurement/4.jpg"} />
          </View>
          <View style={styles.imageArea} wrap={false}>
