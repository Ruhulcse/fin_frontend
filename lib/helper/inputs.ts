...
export const registrationInputs = [
	...
	},
	{
		...
		label: "How many times per week would you prefer to train? 1, 2, 3, 4, 5, 6, 7",
		type: 'number',
	},
	{
	...
	{
		name: 'home_equipment',
		label: "If you chose home, what equipment do you have? For example, bands, TRX straps, weights, pull-up bar, weight bench, or none at all?",
		type: 'text',
	},
	{
		name: 'desired_equipment',
		label: "If you chose home, what equipment would you like to purchase from the list you don't currently have (Recommended: TRX or small weight set)?",
		type: 'text',
	},
	{
	...
	},
	{
		...
		label: "What are your favorite exercises? If you don't know, write `don't know.`",
		type: 'text',
	},
	{
		name: 'preferred_focus_areas',
		label: "Which areas would you prefer to focus on more in your personal training program? Chest, arms, back, legs, glute emphasis, shoulders, abs, etc. You can also write the whole body equally or specify certain preferred areas.",
		type: 'text',
	},
	{
		name: 'injuries',
	...
	},
	{
		...
		label: "Do you track your food intake? If yes, do you use an app or a written menu?",
		type: 'text',
	},
	{
		name: 'past_diets',
	...
	},
	{
		...
		label: "Describe a full day of your current nutrition, what a regular day looks like, what you eat when you wake up, lunch, dinner, snacks.",
		type: 'text',
	},
	{
	...
	},
	{
		...
		label: "And now, what does your weekend look like? If there's a special meal on Friday and Saturday, what does it usually include?",
		type: 'text',
	},
	{
		name: 'favorite_recipes',
		label: "Do you have recipes you like to make frequently, say once a week? If yes, list all the ingredients and quantities and how many units result from each preparation (you can list several recipes).",
		type: 'text',
	},
	{
	...
	{
		name: 'medications',
		label: "Medications and prescriptions you are currently and have previously used?",
		type: 'text',
	},
	{
		name: 'sleep_hours',
	...
	},
	{
		...
		label: "Do you commit to declaring and being transparent about any use of prohibited substances before starting and during the collaboration? This refers to substances like anabolic steroids, etc.",
		type: 'text',
	},
	{
...
export const healthDeclarationInputs = [
	...
	},
	{
		...
		label: "Is there a recommendation from a doctor to avoid physical activity?",
		type: 'text',
	},
	{
		name: 'home_equipment',
	...
	},
	{
		...
		label: "Are you currently pregnant, recently pregnant, or planning to become pregnant soon? (Please specify below)",
		type: 'text',
	},
	{
		name: 'lung_diseases',
	...
	},
	{
		...
		label: "Do you have a hernia or other condition that may worsen from lifting weights?",
		type: 'text',
	},
	{
		name: 'diet',
	...
	},
	{
		...
		label: "Additional comments or details you would like to mention (Please specify below)",
		type: 'text',
	},
	{
		name: 'fat_burners',
		label: "Have you used or are you using steroids, fat burners, etc.? (Please specify below) (Confidential)",
		type: 'text',
	},
	{
		name: 'terms_accepted',
